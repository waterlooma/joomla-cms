	...
	<div class="finder<?php echo $suffix; ?>">
		<div class="control-group">
			...
			<div class="input-append">
				<input type="text" name="q" id="mod-finder-searchword" class="search-query input-medium" size="<?php echo $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')); ?>" />
