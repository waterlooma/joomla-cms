...
<fieldset class="checkboxes impunlimited"><input id="' . $this->id . '_unlimited" type="checkbox" <?php echo $checked; ?> onclick="if (document.getElementById('<?php echo $id; ?>_unlimited').checked) document.getElementById('<?php echo $id; ?>').value='';" />
