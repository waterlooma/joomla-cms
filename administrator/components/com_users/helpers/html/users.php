...
class JHtmlUsers
{
	...
	public static function filterNotes($count, $userId)
	{
		...
		return '<a href="' . JRoute::_('index.php?option=com_users&view=notes&filter_search=uid:' . (int) $userId) . '" class="hasTooltip btn btn-mini" title="'
			. $title . '"><span class="icon-filter"></span></a>';
	}
